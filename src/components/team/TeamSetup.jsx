...
export default class TeamSetup extends PureComponent {
  render() {
    const {
      players,
      region,
    ...
    return (
      <form className="team-container" onSubmit={onSave}>
        ...
        <div className="team-row">
          <label>
            Region:
            <select value={region} onChange={onRegionChange} name="region">
        ...
        <div className="team-help">
          ...
          <code> REACT_APP_RIOT_PROXY_URL </code> to a small proxy that injects
          your Riot API key.
        </div>
      </form>
    );
